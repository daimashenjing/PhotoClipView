...
(function (root, factory) {
    ...
    p._initElements = function () {
        ...
        var $mask = this._$mask = createElement($container, 'photo-clip-mask', {
            ...
            'height': '100%',
            'pointer-events': 'none',
            'background': 'url("data:image/png;base64,") no-repeat center top/100%'
        });
    ...
    p._initFile = function () {
        ...
        if (this._fileList = $(options.file)) {
            this._fileList.forEach(function ($file) {
                attr($file, 'accept', 'image/jpeg,image/png,image/gif');
    ...
    p._resize = function (width, height) {
        ...
        if (this._widthIsPercent || this._heightIsPercent) {
            ...
            if (this._widthIsPercent) {
                this._clipWidth = parseInt(this._containerWidth / 100 * parseFloat(this._widthIsPercent));
                if (this._clipWidth % 2 == 0) {
                    this._clipWidth += 1;
                }
            ...
            if (this._heightIsPercent) {
                this._clipHeight = parseInt(this._containerWidth / 100 * parseFloat(this._heightIsPercent));
                if (this._clipHeight % 2 == 0) {
                    this._clipHeight += 1;
                }
                if (!this._widthIsPercent) {
